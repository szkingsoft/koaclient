...
// CDlgTrendChart 对话框
class CAnalisysObj;
class CDlgTrendChart : public CDialog
{
	DECLARE_DYNAMIC(CDlgTrendChart)

public:
	CDlgTrendChart(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgTrendChart();

// 对话框数据
	enum { IDD = IDD_DLG_TRENDCHART };
public:
